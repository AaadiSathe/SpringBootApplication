...
const Employees = () => {
    ...
    const getAllEmployees = async () => {
        try {
            const response = await axios.get("http://13.233.232.244:3306/sqlbe/api/v1/employee/getAll");
    ...
    const getNextCode = async () => {
        try {
            const response = await axios.get("http://13.233.232.244:3306/sqlbe/api/v1/employee/getNextCode");
            if (response.status === 200) {
    ...
    const saveEmployee = async () => {
        ...
        try {
            const response = await axios.post("http://13.233.232.244:3306/sqlbe/api/v1/employee/save", employeeJSON, {
                headers: {
    ...
    const updateEmployee = async () => {
        ...
        try {
            const response = await axios.put("http://13.233.232.244:3306/sqlbe/api/v1/employee/update", employeeJSON, {
                headers: {
                    'Content-Type': 'application/json'
                }
            });
    ...
    const deleteEmployee = async () => {
        ...
        try {
            const response = await axios.delete(`http://13.233.232.244:3306/sqlbe/api/v1/employee/delete/${employeeCode}`);
            if (response.status === 200) {
